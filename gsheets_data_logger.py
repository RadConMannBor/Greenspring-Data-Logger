...
#        self.log("temp =%s" % self.entities.sensor.greenhouse_temp.state)
        ...
        self.CLIENT_SECRETx_FILE = "client_secret.json"
        ...
        self.pool_3_point_five_active = True

        self.pool_1_temp_control = True
        self.pool_2_temp_control = True
        self.pool_2_5_temp_control = True
        self.pool_3_temp_control = True
        self.pool_4_temp_control = True
        self.pool_3_5_temp_control = True

        # Individiual Sensor On and Off
        self.pool_1_heating_active = True
        self.pool_1_cooling_active = True
        self.pool_2_heating_active = True
        self.pool_2_cooling_active = True
        self.pool_3_heating_active = True
        self.pool_3_cooling_active = True
        self.pool_4_heating_active = True
        self.pool_4_cooling_active = True
        self.pool_3_5_heating_active = True
        self.pool_3_5_cooling_active = False
        self.pool_2_5_cooling_active = True
        self.pool_2_5_heating_active = False
        ...
        self.pool3_5_sensor_off_count = 0
        ...
        self.pool3_5_sensor_off_text = False
        self.standard_temp = []
        ...
        self.pool3_5_heater_on = False
        self.pool3_5_cooler_on = False
        ...
        self.period_of_restart = 8

        self.read_http=True
        self.looked_for_sonoffs = False
        ...
        self.pool1_cooler_turn_on = "http://192.168.1.29/cm?cmnd=Power%20On"
        self.pool1_cooler_turn_off = "http://192.168.1.29/cm?cmnd=Power%20off"
        ...
        # pool 3.5
        self.pool3_5_heater_turn_on = "http://192.168.1.4/cm?cmnd=Power%20On"
        self.pool3_5_heater_turn_off = "http://192.168.1.4/cm?cmnd=Power%20off"
        self.pool3_5_cooler_turn_on = "http://192.168.1.90/cm?cmnd=Power%20On"
        self.pool3_5_cooler_turn_off = "http://192.168.1.90/cm?cmnd=Power%20off"
        # Pool 3.
        self.pool3_heater_turn_on = "http://192.168.1.27/cm?cmnd=Power%20On"
        self.pool3_heater_turn_off = "http://192.168.1.27/cm?cmnd=Power%20off"
        ...
        self.pool1_cooler = "http://192.168.1.29/cm?cmnd=Power"
        self.pool1_heater = "http://192.168.1.11/cm?cmnd=Power"
        self.pool2_heater = "http://192.168.1.8/cm?cmnd=Power"
        self.pool2_cooler = "http://192.168.1.22/cm?cmnd=Power"

        self.pool2_5_cooler = "http://192.168.1.17/cm?cmnd=Power"
        self.pool2_5_heater = "http://192.168.1.4/cm?cmnd=Power"

        self.pool3_5_cooler = "http://192.168.1.90/cm?cmnd=Power"
        self.pool3_5_heater = "http://192.168.1.4/cm?cmnd=Power"

        self.pool3_heater = "http://192.168.1.27/cm?cmnd=Power"
        ...
        # Status
        self.pool1_cooler_status = "http://192.168.1.29/cm?cmnd=Status%209"
        self.pool2_cooler_status = "http://192.168.1.22/cm?cmnd=Status%210"
        self.pool1_heater_status = "http://192.168.1.11/cm?cmnd=Status%209"
        self.pool2_heater_status = "http://192.168.1.8/cm?cmnd=Status%210"
        self.pool2_5_cooler_status = "http://192.168.1.17/cm?cmnd=Status%209"
        self.pool2_5_heater_status = "http://192.168.1.100/cm?cmnd=Status%209"

        self.pool3_5_cooler_status = "http://192.168.1.90/cm?cmnd=Status%209"
        self.pool3_5_heater_status = "http://192.168.1.4/cm?cmnd=Status%209"
        ...
        self.pool3_heater_status = "http://192.168.1.27/cm?cmnd=Status%210"
        ...
        # Pool Solenoid Addresses for Carbonation

        self.pool_3_carbonation_on = "http://192.168.1.21/cm?cmnd=Power%20On"
        self.pool_3_carbonation_off = "http://192.168.1.21/cm?cmnd=Power%20off"
        self.pool_4_carbonation_on = "http://192.168.1.52/cm?cmnd=Power%20On"
        self.pool_4_carbonation_off = "http://192.168.1.52/cm?cmnd=Power%20off"

        self.pool_3_carbonation_active = False
        self.pool_4_carbonation_active = False

        self.pool3_carbonation = "http://192.168.1.21/cm?cmnd=Power"
        self.pool4_carbonation = "http://192.168.1.52/cm?cmnd=Power"

        # Rules Change for Pools
        ...
        self.p3_5_heater_broken = False
        self.p3_5_cooler_broken = False

        self.p3_heater_broken=False
        ...
        self.p3_heater_broken_on_text=False
        ...
        self.p2_5_heater_broken_on_text=False
        self.p2_5_cooler_broken_on_text=False
        self.p3_5_heater_broken_on_text=False
        self.p3_5_cooler_broken_on_text=False
        ...
        self.p3_5_cooler_broken_count = 0
        self.p3_5_heater_broken_count = 0
        ...
        self.p3_5_heater_broken_on_checked = False
        self.p3_5_cooler_broken_on_checked = False
        self.p3_5_heater_broken_off_checked = False
        self.p3_5_cooler_broken_off_checked = False

        self.p3_heater_broken_on_checked=False
        ...
        self.p3_heater_broken_off_text=False
        ...
        self.p2_5_heater_broken_off_text=False
        self.p2_5_cooler_broken_off_text=False
        self.p3_5_heater_broken_off_text=False
        self.p3_5_cooler_broken_off_text=False

        self.p3_heater_broken_off_checked=False
        ...
        self.pool_3_point_five_heating_active = True
        self.pool_3_point_five_cooling_active = False
        self.pool_2_point_five_cooler_active = True
        self.pool_2_point_five_heater_active = False


        # Restart Pump Booleans
        self.pool_3_5_restart_pump = False
        self.pool_3_restart_pump = False
        self.pool_4_restart_pump = False

        # Restart Pump Count
        self.pool_3_5_restart_pump_count = 0
        self.pool_3_restart_pump_count = 0
        self.pool_4_restart_pump_count = 0

        self.pool_3_5_restart_pump_text_count = 0
        self.pool_3_restart_pump_text_count = 0
        self.pool_4_restart_pump_text_count = 0
        # Command Flag Boolean
        self.look_for_command = False
        # Carbonate Pools
        self.carbonate_tonight = False
        ...
        self.photosynq_p2_5_spreadsheet_id = 68354773
        self.photosynq_p3_5_spreadsheet_id = 258754398
        ...
        self.pool_3_5_spreadsheet_id = 829551204
        ...
        self.six_failure_cycles = 6 #Needs to b 6
        ...
        # Service Key
        # secret_file = os.environ.get('service_key')
        # x= json.loads(secret_file, strict=False)
        # # print(x)
        # self.credentials = service_account.Credentials.from_service_account_info(x, scopes=self.scopes)
        # self.service = discovery.build('sheets', 'v4', credentials=self.credentials)
        # self.log("after services - discover.build")

        try:
            self.send_text("Raspberry pi Restarted", "Conrad")
            self.send_text("Raspberry pi Restarted", "Mickey")
            # self.send_text("Final test to see if it comes from an email using mms and not a random number using sms", "Sasha")
            # self.send_text_mms("New function for sending message, see if it uses mms now.", "Sasha")
            # self.send_text_mms("New function for sending message, see if it uses mms now.", "Conrad")
            # self.text_notification("Access Point dropped sonoffs for some reason but, connection is rea system is Functional.")
            # self.test()
        ...
        # Look For Sonoffs and try to add them dynamically
        # try:
        ...
        self.log("Pool 1 temp =%s" % self.entities.sensor.pool_1_temp.state)
        self.log("Pool 2 temp =%s" % self.entities.sensor.pool_2_temp.state)
        self.log("Pool 2.5 temp =%s" % self.entities.sensor.pool_2_5_temp.state)
        self.log("Pool 3.5 temp =%s" % self.entities.sensor.pool_3_5_temp.state)
        ...
        # self.check_last_restart()
        try:
            print("Test if Restart Works:")
            print(self.check_last_restart())
        except:
            print("Failed check Last restart")
        # self.check_active_pools()
        # self.get_photosynq()
        # try:
        #     print("Start testing photosynq")
        #     self.get_photosynq()
        # except Exception as e:
        #     print(e)
    ...
    def start_logging(self):
        ...
        try:
            ...
            #     active_pools = self.gsheets_retrieve_data('Control!D2:D7', self.spreadsheet_id)
            #     active_sensors = self.gsheets_retrieve_data('Control!I2:I13', self.spreadsheet_id)
            #     if(active_pools[0] == '0'):
            ...
            #     if(active_pools[5] == '0'):
            #         self.pool_3_point_five_active = False
            #         print("Pool 3.5 Inactive")
            #     else:
            #         print("Pool 3.5 Active")
            ...
            while True:
                if(self.google_sheets_started == False):
                    print("Retry connection to google sheets")
                    try:
                        # self.credentials = self.get_credentials()
                        # self.http = self.credentials.authorize(httplib2.Http())
                        # self.service = discovery.build('sheets', 'v4', http=self.http, discoveryServiceUrl=self.discoveryUrl)
                ...
                # Check the Carbonation Timing
                try:
                    carbonation_values = self.gsheets_retrieve_data('Control!G2:G5', self.spreadsheet_id)
                    print(carbonation_values)
                    if(carbonation_values[3] == "1"):
                        self.carbonate_tonight = True
                    else:
                        self.carbonation_tonight = False
                    pool_to_carbonate = carbonation_values[0]
                    start_time = datetime.strptime(carbonation_values[1], '%H:%M:%S')
                    end_time = datetime.strptime(carbonation_values[2], '%H:%M:%S')

                    if(self.carbonate_tonight):
                        print("Made it to carboante tonight")
                        self.carbonate_pools(pool_to_carbonate, start_time, end_time)
                    ...
                    print("Carbonation Check Failed")
                    print(e)
                ...
                n = 0
                try:
                    # Do one instance of controllig temp at the beginning
                    # try:
                    ...
                    try:
                        ...
                        if(self.restart_counter == self.six_failure_cycles):
                            ...
                            self.restart_pi(self.check_last_restart())
                            # self.restart_pi(True)
                    ...
                    if(self.photosynq_trigger == True):
                        try:
                            self.get_photosynq()
                            # print("Photosynq disabled for now")
                   ...
                   #  
                    try:
                        try:
                            control_values2 = self.gsheets_retrieve_data('Control!B9:B25', self.spreadsheet_id)
                            print(control_values2)

                            standard_temp = control_values2

                            control_values3 = self.gsheets_retrieve_data('Control!B27:B36', self.spreadsheet_id)

                            sunrise_sunset_delay = self.gsheets_retrieve_data('Control!K2:K3', self.spreadsheet_id)
                            print(control_values3)
                            self.period_of_restart = int(control_values3[5])
                            print("Period of Restart:")
                            print(self.period_of_restart)
                        except Exception as e:
                            print(e)
                            print("Retrieve failed, Try once more")
                            control_values2 = self.gsheets_retrieve_data('Control!B9:B25', self.spreadsheet_id)
                            print(control_values2)
                        ...
                        try:
                            ...
                            self.change_pool_rules(control_values2[1], control_values2[2], control_values2[3], control_values2[4], control_values2[5], control_values2[6], control_values2[7], control_values2[8], control_values2[9], control_values2[10], control_values2[11], control_values2[12], sunrise, sunset, control_values3[0], control_values3[1], control_values3[2], control_values3[7], control_values3[8], control_values3[9], sunrise_sunset_delay[0], sunrise_sunset_delay[1])
                    ...
                    # calculate how long the wait time should be
                    try:
                        fmt = '%H:%M:%S'
                        current_time_calc = self.get_time_year()
                        print(current_time_calc)

                        print("Last update time")
                        print(self.last_update_time)
                        date_time_current_time = datetime.strptime(current_time_calc, '%Y-%m-%d %H:%M:%S')
                        date_time_last_update = datetime.strptime(self.last_update_time, '%Y-%m-%d %H:%M:%S')


                        

                        difference_time = date_time_current_time - date_time_last_update
                        print("difference between last update and current time")
                        print(difference_time)
                        seconds = difference_time.total_seconds()
                        print("Seconds")
                        print(seconds)

                        period = 600.0 - seconds
                        print(period)
                        if(period < 0):
                            wait_time = 5
                        else:
                    ...
                    try:
                        self.timing_for_loop = int(control_values3[6])
                    except Exception as e:
                        print("Failed getting control values")
                        print(e)
                    # while n < 10:
                    while n < self.timing_for_loop:
                        try:
                            # print(self.pool3_temp_global)
                            try:
                                self.poll_sensors()
                            except Exception as e:
                                print(e)
                            ...
                            try:
                                ...
                                self.control_pool_temp(control_values2[1], control_values2[2], control_values2[3], control_values2[4], control_values2[5], control_values2[6], control_values2[7], control_values2[8], control_values2[9], control_values2[10], control_values2[11], control_values2[12], sunrise, sunset, control_values3[0], control_values3[1], control_values3[2], control_values3[7], control_values3[8], control_values3[9], sunrise_sunset_delay[0], sunrise_sunset_delay[1])
                                print("After Control Pool Temp")
                                print(self.get_time())
                                # Control Pi Section
                                if(self.look_for_command==True):
                                    print("Look For Command:")
                                ...
                                try:
                                    ...
                                    print(e)
                                    self.control_pool_temp(35, 33, 30, 35, 33, 30, 35, 33, 30, 35, 30, 22, sunrise,sunset, 35, 33, 30, 35, 33, 30, 4, 1 )
                                    traceback.print_exc()
                                    print(e)
                            ...
                            print(self.get_time())
                            if(self.poll_restart_counter > self.period_of_restart):
            ...
            while n < 10:
                        try:
                            ...
                            try:
                                ...
                                self.control_pool_temp(35, 33, 30, 35, 33, 30, 35, 33, 30, 35, 30, 22, 0,0, 35, 33, 30, 35, 33, 30, 4, 1 )
                                traceback.print_exc()
                                print(e)
                            except:
    ...
    def log_sensor_data(self):
        ...
        if(self.pool_3_active):
            if(self.entities.sensor.pool3_temp.state != "unknown" and  self.poll_p3_failed == False):# and self.pool3_temp_global != "unknown"):
                ...
                if(self.pool3_cooler_on == True):
                    ...
                    p3_cool = "0"
            # Insert Pool 3 Data
                if(self.pool_3_carbonation_active):
                    p3_carb_on = "1"
                else:
                    p3_carb_on = "0"
                self.gsheets_insert(cur_time,
                                    ...
                                    str(self.pool3_temp_global),
                                     "Null", "Null",p3_heat, p3_cool, "Null", "Null", p3_carb_on)
        ...
        if(self.pool_4_active):
            if(self.entities.sensor.pool4_temp.state != "unknown" and  self.poll_p4_failed == False): # and self.pool4_temp_global != "unknown"):
                ...
                if(self.pool4_cooler_on == True):
                    ...
                    p4_cool = "0"
                if(self.pool_4_carbonation_active):
                    p4_carb_on = "1"
                else:
                    p4_carb_on = "0"
            # Insert Pool 4 Data
                self.gsheets_insert(cur_time,
                                    ...
                                    str(self.pool4_temp_global),
                                     "Null", "Null", p4_heat, p4_cool, "Null", "Null", p4_carb_on)
        ...
        # Insert Outside Data
        if(self.entities.sensor.outside_temp.state != "unknown" and  self.poll_outside_failed == False and self.entities.sensor.outside_temp.state != "None"):
            self.gsheets_insert(cur_time,
                                self.spreadsheet_id,
        ...
        if(self.pool_1_active):
            ...
            # Insert Pool 3 Data
                self.gsheets_insert(cur_time,
                                    ...
                                    "Null", "Null", p1_heat, p1_cool, "Null", "Null", "Null")
        ...
        if(self.pool_2_active):
            ...
            # Insert Pool 3 Data
                self.gsheets_insert(cur_time,
                                    ...
                                    "Null", "Null", p2_heat, p2_cool, "Null", "Null", "Null")
            ...
            try:
                ...
                # Insert Pool 3 Data
                    self.gsheets_insert(cur_time,
                                        ...
                                        "Null", "Null", p2_5_heat, p2_5_cool, "Null", "Null", "Null")
        ...
        # Pool 3.5
        print(self.pool_3_point_five_active)
        if(self.pool_3_point_five_active):
            try:
                self.log("Pool 3.5 Temp =%s" % self.pool3_5_temp_global and  self.poll_p3_5_failed == False)
                
                if(self.entities.sensor.pool_3_5_temp.state != "unknown"):# and self.pool2_5_temp_global != "unknown"):
                    self.pool3_5_sensor_off_count = 0
                    self.pool3_5_sensor_off_text = False
                    if(self.pool3_5_heater_on == True):
                        p3_5_heat = "5"
                    else:
                        p3_5_heat = "0"
                    # Only one cooling Implement so basing it all off pool 1
                    if(self.pool3_5_cooler_on == True):
                        p3_5_cool = "5"
                    else:
                        p3_5_cool = "0"
                # Insert Pool 3 Data
                    self.gsheets_insert(cur_time,
                                        ...
                                        "pool_3.5_temp",
                                        # self.entities.sensor.pool_2_5_temp.state,
                                        str(self.pool3_5_temp_global),
                                        "Null", "Null", p3_5_heat, p3_5_cool, "Null", "Null", "Null")

                    


                elif(self.entities.sensor.pool_3_5_temp.state == "unknown" and self.pool3_5_sensor_off_count>1 and self.pool3_5_sensor_off_text != True):
                    text = "Pool 3.5 Sensor is Not Recording Please Check"
                    self.text_notification(text)
                    self.pool3_5_sensor_off_text = True

                else:
                    self.pool3_5_sensor_off_count = self.pool3_5_sensor_off_count + 1
        ...
        # Exhausts
        try:
            if(self.pool_3_5_heating_active):
                pool_3_5_exhaust = self.entities.sensor.pool_3_5_exhaust.state

            if(self.pool_3_heating_active):
                try:
                    pool_3_exhaust = self.entities.sensor.pool3_exhaust.state
                except:
                    pool_3_exhaust = "Unknown"
            else:
                pool_3_exhaust = "Unknown"

            if(self.pool_4_heating_active):
                try:
                    pool_4_exhaust = self.self.entities.sensor.pool_4_exhaust.state
                except:
                    pool_4_exhaust = "Unknown"
            self.gsheets_insert(cur_time,
                                self.spreadsheet_id,
                                # self.entities.sensor.pool_2_5_temp.last_updated,
                                cur_time,
                                ...
                                # self.entities.sensor.pool_2_5_temp.state,
                                pool_3_exhaust,
                                "Null", "Null", pool_3_5_exhaust, pool_4_exhaust, "Null", "Null", "Null")
        except Exception as e:
            print(traceback.format_exc())
            # or
            # print(sys.exc_info()[2])
            print("Failed exhausts")
            print(e)
        return(cur_time)
    ...
    #---------------------Google Sheets Insert---------------------
        ...
        # @return:  (None)
    #--------------------------------------------------------------
    def gsheets_insert(self, log_time, spreadsheet_id, last_updated, sheet_name, val1, val2, val3, val4, val5, val6, val7, val8):
        ...
        # Pools 
        elif (val2 == "Null" and val3 == "Null" and val8 != "Null"):
            if(val8 == True):
                val8 = str(1)
            else:
                val8 = str(0)
            data = log_time + "," + local_str + "," + val1 + "," + val4 + "," + val5 + "," + val8
        # Pools with Carbonation
        ...
        elif(sheet_name =="pool_3.5_temp"):
            sheet = self.pool_3_5_spreadsheet_id
        elif(sheet_name =="exhaust_sheet"):
            sheet = self.exhaust_sheet
        else:
    ...
    def send_text(self, message, person):
        ...
        try:
            ...
            mickey_phone = os.getenv('MICKEY_PHONE')
            current_time = self.get_time()
            ...
            if(person == "Aaron"):
                ...
                to_number = mickey_phone.format(carriers['verizon'])
                message = "From: %s\r\n" % auth[0] + "To: %s\r\n" % to_number + "Subject: %s\r\n" % message_subject + "\r\n" + str(current_time) + '  ' + message
    ...
    def send_text_mms(self, message, person):
        message_subject = '--Greenspring Text Notification System--'
        text_user = os.getenv('TEXT_USER')
        text_pass = os.getenv('TEXT_PASSWORD')
        auth = (text_user, text_pass)
        print("Using Different messaging function.")
        ...
        msg['Subject'] = '--Greenspring Text Notification System--'
        msg['From'] = os.getenv('TEXT_USER')
        msg['To'] = to_number

        # Send the message via our own SMTP server.
        server = smtplib.SMTP_SSL('smtp.gmail.com', 465)
        server.login(text_user, text_pass)
    ...
    def check_sensors_text(self, farm_high, farm_low, pool_high, pool_low, greenhouse_high, greenhouse_low):
        ...
        #******************** Pool 3.5 Check Sensors ************************* 

        if(self.pool_3_point_five_active):
            if(self.entities.sensor.pool_3_5_temp.state != "unknown"):
                pool3_5_conv = float(self.entities.sensor.pool_3_5_temp.state)
                
                if(pool3_5_conv > float(pool_high) and self.pool3_5_flag != True):
                    testtext = '___Pool 3.5 Temperature Over Limit___ ' + pool_high + ' C __Value__ ' + str(self.entities.sensor.pool_3_5_temp.state)+ ' C'
                    self.text_notification(testtext)
                    self.log("Pool 3.5 Temp over Limit")
                    self.pool3_5_flag = True
                elif(pool3_5_conv < float(pool_low) and self.pool3_5_flag != True):
                    testtext = '__Pool 3.5 Temperature Under Limit__ ' + pool_low + ' C __Value__ '+ str(self.entities.sensor.pool_3_5_temp.state)+ ' C'
                    self.text_notification(testtext)
                    self.log("Pool 3.5 Temp under Limit")
                    self.pool3_5_flag = True
        ...
        if(self.entities.sensor.pool_3_5_temp.state != "unknown" and self.pool_3_point_five_active):
            if((float(pool_high) > float(self.entities.sensor.pool_3_5_temp.state) > float(pool_low)) and self.pool3_5_flag == True):
                # pool1_conv = float(self.entities.sensor.pool1_temp.state)
                testtext = '__Pool 3.5 Temperature Returned to Acceptable Level__ ' + str(self.entities.sensor.pool_3_5_temp.state) + ' C' 
                self.text_notification(testtext)
                self.pool3_5_flag = False


    def text_notification(self, textout):
        # textoutsasha = textout + "                                                                                                                                                                                                                                                                               ."
        self.send_text(textout, "Conrad")
        # self.send_text(textout, "Sasha")
        # self.send_text(textout, "Aaron")
        # self.send_text(textout, "Elle")
        # self.send_text(textout, 'Mickey')
    ...
    def get_weather(self):
        ...
        print(sunset_readable)
        print(sunrise_readable)

        self.gsheets_insert_single(self.spreadsheet_id, 'Control!',sunrise_readable, 'K4')
        self.gsheets_insert_single(self.spreadsheet_id, 'Control!',sunset_readable, 'K5')
    ...
    #---------------------Control Pool Temperature---------------------
        ...
        # @return: None
    #------------------------------------------------------------------
    def control_pool_temp(self,pool1_high, pool1_low_day, pool1_low_night , pool2_high,pool2_low_day, pool2_low_night, pool3_high, pool3_low_day, pool3_low_night, pool4_high, pool4_low_day, pool4_low_night, sunrise, sunset, pool2_5_high, pool2_5_low_day, pool2_5_low_night, pool3_5_high, pool3_5_low_day, pool3_5_low_night, time_before_sunrise, time_before_sunset):
        time = self.get_time()


        # self.log("Time: %s"%str(time))
        print("Sunrise then sunset:")
        print(datetime.utcfromtimestamp(sunrise).strftime('%H:%M:%S'))
        print(datetime.utcfromtimestamp(sunset).strftime('%H:%M:%S'))
        time_before_sunrise = float(time_before_sunrise)
        time_before_sunset = float(time_before_sunset)
        if(sunset == 0 and sunrise == 0):
            ...
            print("Time before sunrise: ",time_before_sunrise," sunset:", time_before_sunset)
            # print(time_before_sunrise)
            # print(time_before_sunset)
            delay_sunrise = time_before_sunrise * 3600
            delay_sunset = time_before_sunset * 3600
            print("Sunrise Delay:", time_before_sunrise, "Sunset Delay:", time_before_sunset)
            # print(delay_sunrise)
            # print(delay_sunset)
            sunrise_use = sunrise - delay_sunrise
            sunrise_use = datetime.utcfromtimestamp(sunrise_use).strftime('%H:%M:%S')
            sunset_use = sunset - delay_sunset
            sunset_use = datetime.utcfromtimestamp(sunset_use).strftime('%H:%M:%S')
            # self.log("Sunrise time: %s"%str(sunrise_use))
            # self.log("Sunset time: %s"%str(sunset_use))
        # print("In control pool temp")
        print(sunrise_use)
        print(sunset_use)
        ...
        # print(peak_energy_start)
        # print(peak_energy_end)
        ...
        if(time > sunrise_use and time < sunset_use):
            ...
            pool3_5_low = pool3_5_low_day
            # self.gsheets_insert_single(self.spreadsheet_id, 'Control!',"Day", 'K6')
        # If time 
            ...
            pool3_low = pool3_low_night
            pool4_low =  pool4_low_night
            pool3_5_low = pool3_5_low_night
            # self.gsheets_insert_single(self.spreadsheet_id, 'Control!',"Night", 'K6')
        ...
        # print("Pool 3 Cooling Temp:")
        # print(pool3_high)

        # pool4_turn_off = int(pool4_high)
        # pool4_turn_off = pool4_turn_off - 3
        # pool4_turn_off = str(pool4_turn_off)

        # pool3_turn_off = int(pool3_high)
        # pool3_turn_off = pool3_turn_off - 3
        # pool3_turn_off = str(pool3_turn_off)

        # pool1_turn_off = int(pool1_low)
        # pool1_turn_off = pool1_turn_off + 3
        # pool1_turn_off = str(pool1_turn_off)

        # pool2_turn_off = int(pool2_high)
        # pool2_turn_off = pool2_turn_off - 3
        # pool2_turn_off = str(pool2_turn_off)

        # pool2_5_turn_off = int(pool2_5_high)
        # pool2_5_turn_off = pool2_5_turn_off - 3
        # pool2_5_turn_off = str(pool2_5_turn_off)
        ...
        #-----------------Pool 1-------------------------
        #-----------------Pool 2-------------------------
        if(self.pool_1_temp_control):
            try:
                if(self.entities.sensor.pool_1_temp.state != "unknown"):
                    pool1_conv = float(self.entities.sensor.pool_1_temp.state)
                    if(self.pool_1_heating_active):
                ...
                print(e)
                testtext = 'Pool 1 Failed'
         
        #-----------------Pool 2-------------------------
        if(self.pool_2_temp_control):
            try:
                if(self.entities.sensor.pool_2_temp.state != "unknown"):
                    pool2_conv = float(self.entities.sensor.pool_2_temp.state)
                    if(self.pool_2_heating_active):
                        ...
                        if(pool2_conv > float(pool2_low) and self.pool2_heater_on == True):
                            ...
                            try:
                                ...
                                if(self.p2_heater_broken_off_checked == False):
                                    ...
                                    self.text_notification(testtext)
                    if(self.pool_2_cooling_active):
                        if(pool2_conv > float(pool2_high) and self.pool2_cooler_on != True and self.pool2_heater_on != True):
                            self.log("Pool 2 Cooler Turned On. Too Hot Temp: %s" % self.entities.sensor.pool_2_temp.state)
                            self.pool2_cooler_on = True 
                            try:
                                self.send_http(self.pool2_cooler_turn_on)
                                textout = 'Pool 2 Cooler Turned on at ' + str(self.entities.sensor.pool_2_temp.state)
                                # self.send_text(textout, "Conrad")
                            # Pool 4 Cooler is not responding
                            except:
                                self.log("Failed to http get request to the site.")
                                if(self.p2_cooler_broken_on_checked == False):
                                    self.check_sonoff_status()
                                    self.p2_cooler_broken_on_checked = True
                                elif(self.p2_cooler_broken_on_text == False):
                                    testtext = 'Pool 2 Turn Cooler On Failed, Please Check'
                                    self.text_notification(testtext)
                                    self.p2_cooler_broken_on_text = True
                        if(pool2_conv < float(pool2_high) and self.pool2_cooler_on == True):
                            self.log("Pool 2 Cooler Turned Off. Current Temp: %s"% self.entities.sensor.pool_2_temp.state)
                            self.pool2_cooler_on = False
                            try:
                                self.send_http(self.pool2_cooler_turn_off)
                            except:
                                if(self.p2_cooler_broken_off_checked == False):
                                    self.check_sonoff_status()
                                    self.p2_cooler_broken_off_checked = True
                                elif(self.p2_cooler_broken_off_text == False): 
                                    self.log("Failed to http get request to the site.")
                                    testtext = 'Pool 2 Turn Cooler Off Failed, Please Check'
                                    self.text_notification(testtext)
            except Exception as e:
                print(e)
                testtext = 'Pool 2 Failed'
                # self.send_text(testtext, "Conrad")
        ...
        # Pool 2.5 !
        # if(self.pool_2_point_five_active):
        if(self.pool_2_5_temp_control):
            try:
                if(self.entities.sensor.pool_2_5_temp.state != "unknown"):
                    pool2_5_conv = float(self.entities.sensor.pool_2_5_temp.state)
                    if(self.pool_2_5_heating_active):
                        if(pool2_5_conv < float(pool2_5_low) and self.pool2_5_heater_on != True and self.pool2_5_cooler_on != True):
                            ...
                            try:
                                ...
                                if(self.p2_5_heater_broken_on_checked == False):
                                    ...
                                    self.log("Failed to http get request to the site.")
                                    testtext = 'Pool 2.5 Turn Heater On Failed, Please Check'
                                    self.text_notification(testtext)
                    ...
                    if(self.pool_2_5_cooling_active):
        ...
        if(self.pool_3_temp_control):
            try:
                if(self.entities.sensor.pool3_temp.state != "unknown"):
                    ...
                    if(self.pool_3_heating_active):
                        if(pool3_conv > float(pool3_low) and self.pool3_heater_on == True):
                            ...
                            self.pool3_heater_on = False
                            try:
                                self.send_http(self.pool3_heater_turn_off)
                            except:
                                if(self.p3_heater_broken_off_checked == False):
                                    self.check_sonoff_status()
                                    self.p3_heater_broken_off_checked = True
                                elif(self.p3_heater_broken_off_text == False): 
                                    self.log("Failed to http get request to the site.")
                                    testtext = 'Pool 3 Turn Heater Off Failed, Please Check'
                                    self.text_notification(testtext)
                        # Reboot Heating Pump for Pool 3.5
                        if(pool3_conv < float(pool3_low) and self.pool3_heater_on != True and self.pool3_cooler_on != True):
                            ...
                            try:
                                self.send_http(self.pool3_heater_turn_on)
                            # Pool 4 Heater is not responding
                            except:
                                if(self.p3_heater_broken_on_checked == False):
                                    self.check_sonoff_status()
                                    self.p3_heater_broken_on_checked = True
                                elif(self.p3_heater_broken_on_text == False):
                                    self.log("Failed to http get request to the site.")
                                    testtext = 'Pool 3 Turn Heater On Failed, Please Check'
                                    self.text_notification(testtext)

                                    self.p3_heater_broken_on_text==True
                        if(self.pool3_heater_on == True):
                            try:
                                # print("Check the Boolean for the restart of pool 3 pump.")
                                # print(self.pool_3_restart_pump)
                                if(self.pool_3_restart_pump):
                                    print("Turn off Pump to restart pool 3 heating system")
                                    self.send_http(self.pool3_heater_turn_off)
                                    self.pool_3_restart_pump = False
                                    self.pool_3_restart_pump_count = 0
                                else:
                    ...
                    if(self.pool_3_cooling_active):
                        if(pool3_conv > float(pool3_high) and self.pool3_cooler_on != True and self.pool3_heater_on != True):
                            ...
                            # Pool 4 Cooler is not responding
                                ...
                                elif(self.p3_cooler_broken_on_text == False):
                                    testtext = 'Pool 3 Turn Cooler On Failed, Please Check'
                                    self.text_notification(testtext)
                                    self.p3_cooler_broken_on_text = True
                        if(pool3_conv < float(pool3_high) and self.pool3_cooler_on == True):
                            ...
                            try:
                                ...
                                if(self.p3_cooler_broken_off_checked == False):
                                    self.check_sonoff_status()
                                    self.p3_cooler_broken_off_checked = True
                                elif(self.p3_cooler_broken_off_text == False): 
                                    self.log("Failed to http get request to the site.")
                ...
                print(e)
                testtext = 'Pool 3 Control pool Temp Failed'
                self.send_text(testtext, "Conrad")
        # if(self.pool_3_active):
        # if(self.pool_3_temp_control):
        #     if(self.entities.sensor.pool3_temp.state != "unknown"):
        ...
        #             print("Pool 3 low")
        #             print(pool3_low)
        #             if(pool3_conv > float(pool3_low)):
        #                 print("Pool 3 is above pool 3 low temp")
        #             print("pool 3 heater on boolean:")
        #             print(self.pool3_heater_on)
        ...
        # Pool 3.5 !
        # if(self.pool_3_point_five_active):
        if(self.pool_3_5_temp_control):
            try:
 
                if(self.entities.sensor.pool_3_5_temp.state != "unknown"):
                    pool3_5_conv = float(self.entities.sensor.pool_3_5_temp.state)
                    # print("---------------------in pool 3.5 control pool temp-----------------")
                    # print(pool3_5_conv)
                    if(self.pool_3_5_heating_active):

                        if(pool3_5_conv < float(pool3_5_low) and self.pool3_5_heater_on != True and self.pool3_5_cooler_on != True):
                            self.log("Pool 3.5 Heater Turned On. Too Cool Temp: %s"% self.entities.sensor.pool_3_5_temp.state)
                            self.pool3_5_heater_on = True
                            

                            try:
                                
                                self.send_http(self.pool3_5_heater_turn_on)
                            # Pool  Heater is not responding
                            except:
                                if(self.p3_5_heater_broken_on_checked == False):
                                    self.check_sonoff_status()
                                    self.p3_5_heater_broken_on_checked = True
                                elif(self.p3_5_heater_broken_on_text == False):
                                    self.log("Failed to http get request to the site.")
                                    testtext = 'Pool 3.5 Turn Heater On Failed, Please Check'
                                    self.text_notification(testtext)
                                    self.p3_5_heater_broken_on_text==True
                        
                        if(pool3_5_conv > float(pool3_5_low) and self.pool3_5_heater_on == True):
                            print("Low pool 3.5 limit")
                            print(pool3_5_low)
                            self.log("Pool 3.5 Heater Turned Off. Current Temp: %s"% self.entities.sensor.pool_3_5_temp.state)
                            self.pool3_5_heater_on = False
       
                            try:
                                print("Turn off Pool 3.5")
                                self.send_http(self.pool3_5_heater_turn_off)
                            except:
                                if(self.p3_5_heater_broken_off_checked == False):
                                    self.check_sonoff_status()
                                    self.p3_5_heater_broken_off_checked = True
                                elif(self.p3_5_heater_broken_off_text == False): 
                                    self.log("Failed to http get request to the site.")
                                    testtext = 'Pool 3.5 Turn Heater Off Failed, Please Check'
                                    self.text_notification(testtext)
                        if(self.pool3_5_heater_on == True):
                            try:
                                # print("Check the Boolean for the restart of pool 3.5 pump.")
                                # print(self.pool_3_5_restart_pump)
                                if(self.pool_3_5_restart_pump):
                                    print("Turn off Pump to restart pool 3.5 heating system")
                                    self.send_http(self.pool3_5_heater_turn_off)
                                    self.pool_3_5_restart_pump = False
                                    self.pool_3_5_restart_pump_count = 0
                                else:
                    ...
                    if(self.pool_3_5_cooling_active):
                        if(pool3_5_conv > float(pool3_5_high) and self.pool3_5_cooler_on != True and self.pool3_5_heater_on != True):
                            self.log("Pool 3.5 Cooler Turned On. Too Hot Temp: %s" % self.entities.sensor.pool_3_5_temp.state)
                            self.pool3_5_cooler_on = True 
                            try:
                                self.send_http(self.pool3_5_cooler_turn_on)
                                textout = 'Pool 3.5 Cooler Turned on at ' + str(self.entities.sensor.pool_3_5_temp.state)
                                # self.send_text(textout, "Conrad")
                            # Pool 3.5 Cooler is not responding
                            except:
                                self.log("Failed to http get request to the site.")
                                if(self.p3_5_cooler_broken_on_checked == False):
                                    self.check_sonoff_status()
                                    self.p3_5_cooler_broken_on_checked = True
                                elif(self.p3_5_cooler_broken_on_text == False):
                                    testtext = 'Pool 3.5 Turn Cooler On Failed, Please Check'
                                    self.text_notification(testtext)
                                    self.p3_5_cooler_broken_on_text = True
                        
                            
                        if(pool3_5_conv < float(pool3_5_high) and self.pool3_5_cooler_on == True):
                            self.log("Pool 3.5 Cooler Turned Off. Current Temp: %s"% self.entities.sensor.pool_3_5_temp.state)
                            self.pool3_5_cooler_on = False
                            try:
                                self.send_http(self.pool3_5_cooler_turn_off)
                            except:
                                if(self.p3_5_cooler_broken_off_checked == False):
                                    self.check_sonoff_status()
                                    self.p3_5_cooler_broken_off_checked = True
                                elif(self.p3_5_cooler_broken_off_text == False): 
                                    self.log("Failed to http get request to the site.")
                                    testtext = 'Pool 3.5 Turn Cooler Off Failed, Please Check'
                                    self.text_notification(testtext)

                # Check the exhausts if they are the correct temp.
                self.check_heat_pump_exhausts()

                    
       
            except Exception as e:
                print(e)
                testtext = 'Pool 3.5 Failed'
                # self.send_text(testtext, "Conrad")

        # Template for 2 sonoff pools
        #      #-----------------Pool 3-------------------------
        # # if(self.pool_3_active):
        # if(self.pool_3_temp_control):
        #     if(self.entities.sensor.pool3_temp.state != "unknown"):
   ...
   #---------------------Check Relays---------------------
    ...
    def check_relays(self):
        ...
        if(self.pool_3_active):
            if(self.pool_3_heating_active):
                try:
                    r = requests.get(url = self.pool3_heater)
                    data1 = r.json() 
                    self.p3_heater_broken_count = 0
                    if(data1["POWER"] == "ON"):
                        self.pool3_heater_on = True
                    else:
                        self.pool3_heater_on = False
                    ...
                    self.p3_heater_broken = True
                    self.log("Pool 3 Heater is failing, probably off or not connected.")
                    self.pool3_heater_on = False
                    self.p3_heater
                    if(self.p3_heater_broken_count ==0):
                        self.reassign_sonoff_address()
                    if(self.p3_heater_broken_count >2):
                        text = "Pool 3 Heater Sonoff is not connected to network please check"
                        self.text_notification(text)
                # try:
                #     r = requests.get(url = self.pool3_heater)
                #     data1 = r.json() 
                ...
                # if(self.p3_heater_broken==True and self.p3_heater2_broken==True and self.p3_heater_broken_on_text==False and self.p3_heater2_broken_on_text==False):
                #     testtext='Pool 3 both heaters are not responding please check.'
                #     self.p3_heater_broken_on_text=True
                #     self.p3_heater_broken_on_text=True
                #     self.send_text(testtext,"Conrad")
                # elif(self.p3_heater_broken==True and self.p3_heater_broken_on_text==False):
                #     self.p3_heater_broken_on_text=True
            ...
            if(self.pool_3_cooling_active):
                ...
                if(self.p3_cooler_broken == True and self.p3_cooler_broken_count >3 and self.p3_cooler_broken_off_text ==False):
                    testtext='Pool 3 Temp and Cooling Failed relay check, may be off network.'
                    # self.text_notification(testtext)
                    self.send_text(testtext, "Conrad",)
        ...
        if(self.pool_2_point_five_active):
            ...
            if(self.pool_3_5_cooling_active):
                ...
                if(self.p2_5_cooler_broken == True and self.p2_5_cooler_broken_count >2 and self.p2_5_cooler_broken_off_text ==False):
                    ...
                    self.text_notification(testtext)
                    self.p2_5_cooler_broken_off_text = True
        ...
        if(self.pool_3_point_five_active):
            ...
            if(self.pool_3_5_heating_active):
                try:
                    r = requests.get(url = self.pool3_5_heater)
                    data1 = r.json() 
                    if(data1["POWER"] == "ON"):
                        self.pool3_5_heater_on = True
                        # print("Pool 3.5 Heater is on")
                        
                    else:
                        self.pool3_5_heater_on = False
                        # print("Pool 3.5 Heater is off")
                except:
                    self.p3_5_heater_broken = True
                    self.log("Pool 3.5 Heater is failing, probably off or not connected.")
                    self.pool3_5_heater_on = False

                if(self.p3_5_heater_broken == True and self.p3_5_heater_broken_count >2 and self.p3_5_heater_broken_off_text ==False):
                    testtext='Pool 3.5 Temp and Heating is not on the network.'

                    self.text_notification(testtext)
                    self.p3_heater_broken_off_text = True
            ...
            if(self.pool_3_5_cooling_active):
                try:
                    r = requests.get(url = self.pool3_5_cooler)
                    data1 = r.json() 
                    if(data1["POWER"] == "ON"):
                        self.pool3_5_cooler_on = True
                    else:
                    ...
                    self.p3_5_cooler_broken = True
                    self.log("Pool 3.5 cooler has failed and needs to be checked")
                    self.pool3_5_cooler_on = False
                    if(self.p3_5_cooler_broken_count==0):
                        # self.reassign_sonoff_address()
                        print("Do reassign")
                    self.p3_5_cooler_broken_count = self.p3_5_cooler_broken_count + 1

                if(self.p3_5_cooler_broken == True and self.p3_5_cooler_broken_count >2 and self.p3_5_cooler_broken_off_text ==False):
                    testtext='Pool 3.5 Cooling is not on the network.'
        ...
        # Pool Carbonation  check
        try:
            r = requests.get(url = self.pool3_carbonation)
            data1 = r.json() 
            if(data1["POWER"] == "ON"):
                self.pool_3_carbonation_active = True
            else:
                self.pool_3_carbonation_active = False
        except:
            
            self.log("Pool 3 carbonation is not working")
            self.pool_3_carbonation_active = False

        try:
            r = requests.get(url = self.pool4_carbonation)
            data1 = r.json() 
            if(data1["POWER"] == "ON"):
                self.pool_4_carbonation_active = True
            else:
                self.pool_4_carbonation_active = False
        except:
           
            self.log("Pool 4 carbonation is not working")
            self.pool_4_carbonation_active = False
        # Lights
    ...
    def get_photosynq(self):
        ...
        try:
            ...
            p2_5_most_recent_time = self.gsheets_retrieve_data('Photosynq P2_5!A2:A2', self.spreadsheet_id)
            p3_5_most_recent_time = self.gsheets_retrieve_data('Photosynq P3_5!A2:A2', self.spreadsheet_id)
        ...
        p2_5_recent_time = datetime.strptime(p2_5_most_recent_time[0], '%Y-%m-%d %H:%M:%S')
        p3_5_recent_time = datetime.strptime(p3_5_most_recent_time[0], '%Y-%m-%d %H:%M:%S')

        # print(p1_recent_time)
        # print(p2_recent_time)
        # print(p3_recent_time)
        # print(p4_recent_time)
        # print(p2_5_recent_time)
        # print(p3_5_recent_time)
        ...
        for key, value in df["Photosynthesis RIDES 2.0"]["time"].items() :

            datetime_object = datetime.strptime(df["Photosynthesis RIDES 2.0"]["time"][key], '%m/%d/%Y, %H:%M:%S %p')
            ...
            # ---------Pool 1----------
            if(p1_recent_time < datetime_object and df["Photosynthesis RIDES 2.0"]["Which pool is being tested?"][key] == "Pool 1 Pre"):
            # if(df["Photosynthesis RIDES 2.0"]["Which pool is being tested?"][key] == "Pool 3"):
                print("Pool 1 New Value Before the last Value!")
                # Stuff
                # p3_time = str(df["Photosynthesis RIDES 2.0"]["time"][key])
                p1_time = str(datetime_object)
                p1_time = p1_time.replace(',', '')
                p1_phi2 = df["Photosynthesis RIDES 2.0"]["Phi2"][key]
                p1_phinpq = df["Photosynthesis RIDES 2.0"]["PhiNPQ"][key]
                p1_relative_chlorophyll = df["Photosynthesis RIDES 2.0"]["SPAD"][key]
                print(p1_time)
                print("Pool 1 Phi2")
                print(df["Photosynthesis RIDES 2.0"]["Phi2"][key])
                print("Pool 1 PhiNPQ")
                print(df["Photosynthesis RIDES 2.0"]["PhiNPQ"][key])
                print("Pool 1 Relative Chlorophyl")
                print(df["Photosynthesis RIDES 2.0"]["SPAD"][key])
            ...
            if(p1_recent_time < datetime_object and df["Photosynthesis RIDES 2.0"]["Which pool is being tested?"][key] == "Pool 1 Post"):
            # if(df["Photosynthesis RIDES 2.0"]["Which pool is being tested?"][key] == "Pool 3"):
                print("Pool 1 New Value Before the last Value!")
                # Stuff
                # p3_time = str(df["Photosynthesis RIDES 2.0"]["time"][key])
            ...
            # ---------Pool 2----------
            if(p2_recent_time < datetime_object and df["Photosynthesis RIDES 2.0"]["Which pool is being tested?"][key] == "Pool 2 Pre"):
            # if(df["Photosynthesis RIDES 2.0"]["Which pool is being tested?"][key] == "Pool 4"):
                print("Pool 2 New Value Before the last Value!")
                # Stuff
                # p4_time = str(df["Photosynthesis RIDES 2.0"]["time"][key])
                p2_time = str(datetime_object)
                p2_time = p2_time.replace(',', '')
                p2_phi2 = df["Photosynthesis RIDES 2.0"]["Phi2"][key]
                p2_phinpq = df["Photosynthesis RIDES 2.0"]["PhiNPQ"][key]
                p2_relative_chlorophyll = df["Photosynthesis RIDES 2.0"]["SPAD"][key]
                print(p2_time)
                print("Pool 2 Phi2")
                print(df["Photosynthesis RIDES 2.0"]["Phi2"][key])
                print("Pool 2 PhiNPQ")
            ...
            if(p2_recent_time < datetime_object and df["Photosynthesis RIDES 2.0"]["Which pool is being tested?"][key] == "Pool 2 Post"):
            # if(df["Photosynthesis RIDES 2.0"]["Which pool is being tested?"][key] == "Pool 4"):
                print("Pool 2 New Value Before the last Value!")
                # Stuff
                # p4_time = str(df["Photosynthesis RIDES 2.0"]["time"][key])
            ...
            if(p3_recent_time < datetime_object and df["Photosynthesis RIDES 2.0"]["Which pool is being tested?"][key] == "Pool 3 Pre"):
            # if(df["Photosynthesis RIDES 2.0"]["Which pool is being tested?"][key] == "Pool 3"):
                ...
                p3_phi2 = df["Photosynthesis RIDES 2.0"]["Phi2"][key]
                p3_phinpq = df["Photosynthesis RIDES 2.0"]["PhiNPQ"][key]
                p3_relative_chlorophyll = df["Photosynthesis RIDES 2.0"]["SPAD"][key]
                print(p3_time)
                print("Pool 3 Phi2")
                print(df["Photosynthesis RIDES 2.0"]["Phi2"][key])
                print("Pool 3 PhiNPQ")
            ...
            if(p3_recent_time < datetime_object and df["Photosynthesis RIDES 2.0"]["Which pool is being tested?"][key] == "Pool 3 Post"):
            # if(df["Photosynthesis RIDES 2.0"]["Which pool is being tested?"][key] == "Pool 3"):
                print("Pool 3 New Value Before the last Value!")
                # Stuff
                # p3_time = str(df["Photosynthesis RIDES 2.0"]["time"][key])
            ...
            # ---------Pool 4----------
            if(p4_recent_time < datetime_object and df["Photosynthesis RIDES 2.0"]["Which pool is being tested?"][key] == "Pool 4 Pre"):
            # if(df["Photosynthesis RIDES 2.0"]["Which pool is being tested?"][key] == "Pool 4"):
                ...
                p4_phi2 = df["Photosynthesis RIDES 2.0"]["Phi2"][key]
                p4_phinpq = df["Photosynthesis RIDES 2.0"]["PhiNPQ"][key]
                p4_relative_chlorophyll = df["Photosynthesis RIDES 2.0"]["SPAD"][key]
                print(p4_time)
                print("Pool 4 Phi2")
                print(df["Photosynthesis RIDES 2.0"]["Phi2"][key])
                print("Pool 4 PhiNPQ")
            ...
            if(p4_recent_time < datetime_object and df["Photosynthesis RIDES 2.0"]["Which pool is being tested?"][key] == "Pool 4 Post"):
            # if(df["Photosynthesis RIDES 2.0"]["Which pool is being tested?"][key] == "Pool 4"):
                print("Pool 4 New Value Before the last Value!")
                # Stuff
                # p4_time = str(df["Photosynthesis RIDES 2.0"]["time"][key])
            ...
            # ---------Pool 3----------
            # if(cur_time == time): #doing it once a day and taking all the info from that day.
            if(p3_5_recent_time < datetime_object and df["Photosynthesis RIDES 2.0"]["Which pool is being tested?"][key] == "Pool 3.5 Pre"):
            # if(df["Photosynthesis RIDES 2.0"]["Which pool is being tested?"][key] == "Pool 3"):
                print("Pool 3 New Value Before the last Value!")
                # Stuff
                # p3_time = str(df["Photosynthesis RIDES 2.0"]["time"][key])
                p3_5_time = str(datetime_object)
                p3_5_time = p3_5_time.replace(',', '')
                p3_5_phi2 = df["Photosynthesis RIDES 2.0"]["Phi2"][key]
                p3_5_phinpq = df["Photosynthesis RIDES 2.0"]["PhiNPQ"][key]
                p3_5_relative_chlorophyll = df["Photosynthesis RIDES 2.0"]["SPAD"][key]
                print(p3_5_time)
                print("Pool 3.5 Phi2")
                print(df["Photosynthesis RIDES 2.0"]["Phi2"][key])
                print("Pool 3.5 PhiNPQ")
                print(df["Photosynthesis RIDES 2.0"]["PhiNPQ"][key])
                print("Pool 3.5 Relative Chlorophyl")
                print(df["Photosynthesis RIDES 2.0"]["SPAD"][key])
                self.gsheets_photosynq_insert(self.spreadsheet_id, self.photosynq_p3_5_spreadsheet_id, str(p3_5_time), str(p3_5_phi2), str(p3_5_phinpq), str(p3_5_relative_chlorophyll),  "Pre Mix")

            if(p3_5_recent_time < datetime_object and df["Photosynthesis RIDES 2.0"]["Which pool is being tested?"][key] == "Pool 3.5 Post"):
            # if(df["Photosynthesis RIDES 2.0"]["Which pool is being tested?"][key] == "Pool 3"):
                print("Pool 3.5 New Value Before the last Value!")
                # Stuff
                # p3_time = str(df["Photosynthesis RIDES 2.0"]["time"][key])
                p3_5_time = str(datetime_object)
                p3_5_time = p3_5_time.replace(',', '')
                ...
                print("Pool 3.5 Relative Chlorophyl")
                print(df["Photosynthesis RIDES 2.0"]["SPAD"][key])
                self.gsheets_photosynq_insert(self.spreadsheet_id, self.photosynq_p3_5_spreadsheet_id, str(p3_5_time), str(p3_5_phi2), str(p3_5_phinpq), str(p3_5_relative_chlorophyll),  "Post Mix")
            
            # ---------Pool 2.5----------
            # if(cur_time == time): #doing it once a day and taking all the info from that day.
            if(p2_5_recent_time < datetime_object and df["Photosynthesis RIDES 2.0"]["Which pool is being tested?"][key] == "Pool 2.5 Pre"):
            # if(df["Photosynthesis RIDES 2.0"]["Which pool is being tested?"][key] == "Pool 3"):
                print("Pool 2.5 New Value Before the last Value!")
                # Stuff
                # p3_time = str(df["Photosynthesis RIDES 2.0"]["time"][key])
                p2_5_time = str(datetime_object)
                p2_5_time = p3_5_time.replace(',', '')
                p2_5_phi2 = df["Photosynthesis RIDES 2.0"]["Phi2"][key]
                p2_5_phinpq = df["Photosynthesis RIDES 2.0"]["PhiNPQ"][key]
                p2_5_relative_chlorophyll = df["Photosynthesis RIDES 2.0"]["SPAD"][key]
                print(p2_5_time)
                print("Pool 2.5 Phi2")
                print(df["Photosynthesis RIDES 2.0"]["Phi2"][key])
                print("Pool 2.5 PhiNPQ")
                print(df["Photosynthesis RIDES 2.0"]["PhiNPQ"][key])
                print("Pool 2.5 Relative Chlorophyl")
                print(df["Photosynthesis RIDES 2.0"]["SPAD"][key])
                self.gsheets_photosynq_insert(self.spreadsheet_id, self.photosynq_p2_5_spreadsheet_id, str(p2_5_time), str(p2_5_phi2), str(p2_5_phinpq), str(p2_5_relative_chlorophyll),  "Pre Mix")

            if(p2_5_recent_time < datetime_object and df["Photosynthesis RIDES 2.0"]["Which pool is being tested?"][key] == "Pool 2.5 Post"):
            # if(df["Photosynthesis RIDES 2.0"]["Which pool is being tested?"][key] == "Pool 3"):
                print("Pool 2.5 New Value Before the last Value!")
                # Stuff
                # p3_time = str(df["Photosynthesis RIDES 2.0"]["time"][key])
                p2_5_time = str(datetime_object)
                p2_5_time = p2_5_time.replace(',', '')
                p2_5_phi2 = df["Photosynthesis RIDES 2.0"]["Phi2"][key]
                p2_5_phinpq = df["Photosynthesis RIDES 2.0"]["PhiNPQ"][key]
                p2_5_relative_chlorophyll = df["Photosynthesis RIDES 2.0"]["SPAD"][key]
                print(p2_5_time)
                ...
                print("Pool 2.5 Relative Chlorophyl")
                print(df["Photosynthesis RIDES 2.0"]["SPAD"][key])
                self.gsheets_photosynq_insert(self.spreadsheet_id, self.photosynq_p2_5_spreadsheet_id, str(p2_5_time), str(p2_5_phi2), str(p2_5_phinpq), str(p2_5_relative_chlorophyll),  "Post Mix")
    ...
    #---------------------Restart Pi---------------------
        ...
        # @return: (none)
    #----------------------------------------------------
    def restart_pi(self, restart_bool):
        
        # last_restart = self.gsheets_retrieve_data('Control!B30:B30', self.spreadsheet_id)
        # last_restart_datetime = datetime.strptime(last_restart, '%Y-%m-%d %H:%M:%S')
        # if(last_restart_datetime > )
        # print(self.check_last_restart())
        if(True):    
            try:
                time = self.get_time_year()
                self.gsheets_insert_single(self.spreadsheet_id, 'Control!','0', 'B22')
                self.gsheets_insert_single(self.spreadsheet_id, 'Control!',str(time), 'B30')
            except Exception as e:
    ...
    #---------------------Check Last Restart---------------------
        # @desc:   Looks at last restart of pi and returns bool whether a restart should happen again
        # @param:  (none)
        # @return: (none)
    #----------------------------------------------------
    def check_last_restart(self):
        try:
            last_restart = self.gsheets_retrieve_data('Control!B30:B31', self.spreadsheet_id)

            last_restart_datetime = datetime.strptime(str(last_restart[0]), '%Y-%m-%d %H:%M:%S')

            time = self.get_time_year()
            date_time_current_time = datetime.strptime(time, '%Y-%m-%d %H:%M:%S')

            wait_time = last_restart[1]
            # Convert minutes to seconds
            wait_time = float(wait_time) * 60

            difference_time = date_time_current_time - last_restart_datetime
            print("difference between last restart")
            ...
            period = wait_time - seconds
            print("------------*******This is how long between restarts:*******------------")
            print(period)
    ...
    def get_averages(self):
        try:
            ...
            self.gsheets_insert(str(cur_time), self.spreadsheet_id, str(cur_time) , "Averages", str(pool3_average), str(pool4_average), str(farm_average), str(greenhouse_average), str(illuminance_average), str(clouds_average), "Null", "Null" )
    ...
    def check_sonoff_status(self):
        ...
        try:
            ...
            #------Pool 2.5------
            if(self.pool_2_point_five_active):
                if(self.pool_2_point_five_cooler_active):
                    try:
                        ...
                        reassign_sonoffs_check = True
                        self.reassign_sonoff_address()
                if(self.pool_2_point_five_heater_active):
                    try:
                        URL = self.pool2_5_heater_status
                        r4 = requests.get(url = URL, timeout=10)
                        data2_5 = r4.json() 
                        # print(data4)
                        print(data2_5['Status']['FriendlyName'][0])
            ...
            if(self.pool_3_point_five_active):
                #Cooling
                if(self.pool_3_point_five_cooling_active):
                    try:
                        URL = self.pool3_5_cooler_status
                        r4 = requests.get(url = URL, timeout=10)
                        data3_5 = r4.json() 
                        # print(data4)
                        print(data3_5['Status']['FriendlyName'][0])
                        if(data3_5['Status']['FriendlyName'][0] != u'Pool 3.5 Cooling'):
                            reassign_sonoffs_check = True
                    except Exception as e:
                        print("Pool 3.5 Failed Cooler check.")
                        print(e)
                        reassign_sonoffs_check = True
                        self.reassign_sonoff_address()
                if(self.pool_3_point_five_heating_active):
                    try:
                        URL = self.pool3_5_heater_status
                        r4 = requests.get(url = URL, timeout=10)
                        data3_5 = r4.json() 
                        # print(data4)
                        print(data3_5['Status']['FriendlyName'][0])
                        if(data3_5['Status']['FriendlyName'][0] != u'Pool 3.5 Heat and Temp'):
                            reassign_sonoffs_check = True
                    except:
                        print("Pool 3.5 Failed Heater check.")
                        reassign_sonoffs_check = True
                        self.reassign_sonoff_address()
        except Exception as e:
    ...
    def test(self):
        try:
            ...
            print("Friendly Name")
            print(data4['Status']['FriendlyName'][0])
            print(type(data4['Status']['FriendlyName'][0]))
            if(data4['Status']['FriendlyName'][0] != u'Pool_2_Temp_and_Cooling'):
                reassign_sonoffs_check = True
        except Exception as e:
            print("Pool 2 Failed Cooler check.")
    ...
    def poll_sensors(self):
        if(self.pool_1_active):
            try:
                ...
                pool1_temp = self.pool1_cooler_status.replace('Status%209', 'Status%208')
        ...
        try:
            ...
            pool2_temp = self.pool2_cooler_status.replace('Status%210', 'Status%208')
        ...
        if(self.pool_3_point_five_active):
            if(self.pool_3_point_five_heating_active):
                try:
                    pool3_5_temp = self.pool3_5_heater_status.replace('Status%209', 'Status%208')

                    r = requests.get(url = pool3_5_temp, timeout=10)
                    p3_5_data = r.json() 
                    # print(p2_5_data['StatusSNS']['DS18B20']['Temperature'])
                    self.pool3_5_temp_global = p3_5_data['StatusSNS']['DS18B20']['Temperature']

                except Exception as e:
                    print("Failed pool 3.5 temp check")
                    print(e)
                    self.poll_restart_counter = self.poll_restart_counter + 1
                    print(self.poll_restart_counter)
    ...
    def reassign_sonoff_address(self):
        if(self.looked_for_sonoffs == True):
            print("Dont look for sonoff because i already have")
        else:
            for i in range (3,101):
                ...
                try:
                    ...
                    if(data['Status']['FriendlyName'][0] ==u'Pool_3 Heater 1'):
                        self.pool3_heater_turn_on = "http://192.168.1." + str(i) + "/cm?cmnd=Power%20On"
                        self.pool3_heater_turn_off = "http://192.168.1." + str(i) + "/cm?cmnd=Power%20off"
                        self.pool3_heater = "http://192.168.1." + str(i) + "/cm?cmnd=Power"
                        self.pool3_heater_status = "http://192.168.1." + str(i) + "/cm?cmnd=Status%209"
                    ...
                    #----------------- TAKEN OUT OF CODE-------------
                    # Pool 2.5 Sonoffs
                    # Pool 2.5 Heater Not connected Currently
    ...
    def check_sensor(self):
        ...
        if(self.pool_2_active):
            if(self.entities.sensor.pool_2_temp.state != "unknown"):
                ...
                text = "Pool 2 Sensor is Not Recording Please Check (check_sensor())"
                # self.text_notification(text)
                self.send_text(text, "Conrad")
                self.pool2_sensor_off_text = True
        ...
        if(self.pool_3_point_five_active):
            try:
                ...
                elif(self.entities.sensor.pool_3_5_temp.state == "unknown" and self.pool3_5_sensor_off_count>3 and self.pool3_5_sensor_off_text != True):
                    text = "Pool 3.5 Sensor is Not Recording Please Check"
                    self.text_notification(text)
                    self.pool3_5_sensor_off_text = True
    ...
    def data_buffer(self):
        ...
        # Insert Greenhouse data
        if(self.entities.sensor.greenhouse_temp.state != "unknown"):
            greenhouse_data = str(cur_time) + "," + str(self.entities.sensor.greenhouse_temp.last_updated) + "," +str(self.entities.sensor.greenhouse_temp.attributes.friendly_name) + "," + str(self.entities.sensor.greenhouse_temp.state) + "," + str(self.entities.sensor.greenhouse_humidity.state) + "," + "Null"+ "," + "Null" + "," + "Null"+","+ "Null"+","+ "Null"+","+ "Null"
        ...
        if(self.pool_3_active):
            if(self.entities.sensor.pool3_temp.state != "unknown" ):
                ...
                p3_data = str(cur_time) + "," + str(self.entities.sensor.pool3_temp.last_updated) + "," +str(self.entities.sensor.pool3_temp.attributes.friendly_name) +"," + str(self.entities.sensor.pool3_temp.state) + "," + "Null" + "," + "Null"+ "," + str(p3_heat) + "," + str(p3_cool) +","+ "Null"+","+ "Null"+","+ str(self.pool_3_carbonation_active)
        ...
        if(self.pool_4_active):
            ...
            # Insert Pool 4 Data
                ...
                p4_data = str(cur_time) + "," + str(self.entities.sensor.pool4_temp.last_updated) + "," +str(self.entities.sensor.pool4_temp.attributes.friendly_name) +"," + str(self.entities.sensor.pool4_temp.state) + "," + "Null" + "," + "Null"+ "," + str(p4_heat) + "," + str(p4_cool) +","+ "Null"+","+ "Null"+","+ str(self.pool_4_carbonation_active)
        ...
        if(self.entities.sensor.outside_temp.state != "unknown"):
            ...
            outside_data = str(cur_time) + "," + str(self.entities.sensor.outside_temp.last_updated) + "," +str(self.entities.sensor.outside_temp.attributes.friendly_name) +"," + str(self.entities.sensor.outside_temp.state) + "," + str(self.entities.sensor.outside_humidity.state) + "," + "Null"+ "," + "Null" + "," + "Null"+","+ "Null"+","+ "Null"+","+ "Null"
        ...
        try:
            if(self.entities.sensor.light_illuminance.state != "unknown"):
                ...
                light_data = str(cur_time) + "," + str(self.entities.sensor.light_illumiminance.last_updated) + "," +str(self.entities.sensor.light_illumance.attributes.friendly_name) +"," + str(self.entities.sensor.light_illumance.state) + "," + str(self.entities.sensor.light_infrared.state) + "," + str(self.entities.sensor.light_uv.state)+ "," + "Null" + "," + "Null"+","+ "Null"+","+ "Null"+","+ "Null"
        ...
        try:
            ...
            if(self.pool_1_active):
                ...
                if(self.entities.sensor.pool_1_temp.state != "unknown"):
                    ...
                    p1_data = str(cur_time) + "," + str(self.entities.sensor.pool_1_temp.last_updated) + "," +"pool_1_temp" +"," + str(self.entities.sensor.pool_1_temp.state) + "," + "Null" + "," + "Null"+ "," + str(p1_heat) + "," + str(p1_cool) +","+ "Null"+","+ "Null"+","+ "Null"
            ...
            if(self.pool_2_active):
                if(self.entities.sensor.pool_2_temp.state != "unknown"):
                    ...
                    p2_data = str(cur_time) + "," + str(self.entities.sensor.pool_2_temp.last_updated) + "," +"pool_2_temp" +"," + str(self.entities.sensor.pool_2_temp.state) + "," + "Null" + "," + "Null"+ "," + str(p2_heat) + "," + str(p2_cool) +","+ "Null"+","+ "Null"+","+ "Null"
        ...
        if(self.pool_2_point_five_active):
            try:
                if(self.entities.sensor.pool_2_5_temp.state != "unknown"):
                    ...
                    p2_5_data = str(cur_time) + "," + str(self.entities.sensor.pool_2_5_temp.last_updated) + "," +"pool_2.5_temp" +"," + str(self.entities.sensor.pool_2_5_temp.state) + "," + "Null" + "," + "Null"+ "," + str(p2_5_heat) + "," + str(p2_5_cool) +","+ "Null"+","+ "Null"+","+ "Null"
        ...
        if(self.pool_3_point_five_active):
            try:
                if(self.entities.sensor.pool_3_5_temp.state != "unknown"):
                    ...
                    p3_5_data = str(cur_time) + "," + str(self.entities.sensor.pool_3_5_temp.last_updated) + "," +"pool_3.5_temp" +"," + str(self.entities.sensor.pool_3_5_temp.state) + "," + "Null" + "," + "Null"+ "," + str(p3_5_heat) + "," + str(p3_5_cool) +","+ "Null"+","+ "Null"+","+ "Null"
                    data_list.append(p3_5_data)

                elif(self.entities.sensor.pool_3_5_temp.state == "unknown" and self.pool3_5_sensor_off_count>1 and self.pool2_5_sensor_off_text != True):
                    try:
                        text = "Pool 3.5 Sensor is Not Recording Please Check"
                        self.text_notification(text)
                        self.pool3_5_sensor_off_text = True
    ...
    def check_heat_pump_exhausts(self):
        # Check pool 3

        try:
            if(self.pool_3_heating_active == True and self.pool3_heater_on == True):
                pool_3_exhaust = self.entities.sensor.pool3_exhaust.state
                # print("##################  Pool 3 Exhaust Temp:  ####################")
                # print(pool_3_exhaust)
                if(float(pool_3_exhaust == 0.0)):
                    text = "Pool 3 exhaust is reading at 0 for some reason please check:"
                    # self.send_text( text, "Conrad")
                    self.text_notification(text)
                elif(float(pool_3_exhaust) < 50.0):
                    print("Pool 3 Exhaust is too low and the heater probably failed")
                    self.pool_3_restart_pump_count = self.pool_3_restart_pump_count + 1
                    print("!!!!!Pump restart Count!!!!!!")
                    print(self.pool_3_restart_pump_count)
                else:
                    self.pool_3_restart_pump_count = 0
                    self.pool_3_restart_pump_text_count = 0
                if(self.pool_3_restart_pump_count > 2):
                    print("Got into the restart reason Pool 3---------------")
                    self.pool_3_restart_pump = True
                    self.pool_3_restart_pump_text_count = self.pool_3_restart_pump_text + 1
                    # self.pool_3_restart_pump_count = 0
                    print("@@@@Pool 3 restart pump text count!!!! ====")
                    print(self.pool_3_restart_pump_text_count)
                if(self.pool_3_restart_pump_text_count > 2):
                    failtext = "Pool 3 has tried to restart pump over 3 times, system is malfunctioning or is out of propane."
                    self.text_notification(failtext)
        ...
        # Check pool 4
        # try:
        #     if(self.pool_4_heating_active == True && self.pool4_heater_on == True):
        #         pool_4_exhaust = self.entities.sensor.pool_4_exhaust.state
        #         print(pool_4_exhaust)
        #         if(pool_4_exhaust <60):
        #             print("The Exhaust is too low and the heater probably failed")
        # except Exception as e:
        #     print(e)
        ...
        # Check pool 3.5
        try:
            if(self.pool_3_5_heating_active == True and self.pool3_5_heater_on == True):
                pool_3_5_exhaust = self.entities.sensor.pool_3_5_exhaust.state
                # print("##################  Pool 3.5 Exhaust Temp:  ####################")
                # print(pool_3_5_exhaust)
                if(float(pool_3_5_exhaust == 0.0)):
                    text = "Pool 3.5 exhaust is reading at 0 for some reason please check:"
                    self.send_text( text,"Conrad")
                elif(float(pool_3_5_exhaust) < 40.0):
                    print("Pool 3.5Exhaust is too low and the heater probably failed")
                    self.pool_3_5_restart_pump_count = self.pool_3_5_restart_pump_count + 1
                    print("!!!!!Pump restart Count!!!!11")
                    print(self.pool_3_5_restart_pump_count)
                else:
                    self.pool_3_5_restart_pump_count = 0
                    self.pool_3_5_restart_pump_text_count = 0
                if(self.pool_3_5_restart_pump_count > 2):
                    print("Got into the restart reason Pool 3.5---------------")
                    self.pool_3_5_restart_pump = True
                    self.pool_3_5_restart_pump_text_count = self.pool_3_5_restart_pump_text_count + 1
                    # self.pool_3_5_restart_pump_count = 0
                if(self.pool_3_5_restart_pump_text_count > 2):
                    failtext = "Pool 3.5 has tried to restart pump over 3 times, system is malfunctioning or is out of propane."
                    self.text_notification(failtext)
        ...
        try:
            ...
            for x in f:
                ...
                if(list[2] == "greenhouse_temp"):
                    print(list)
                    self.gsheets_insert(list[0], self.spreadsheet_id, list[0], list[2],list[3],
    ...
    def restart_at_midnight(self):
        try:
            time = self.get_time()
            time_start = 1611187200 #- 7200
            time_start_use = datetime.utcfromtimestamp(time_start).strftime('%H:%M:%S')
            time_end = 1611187275 #- 10800
            time_end_use = datetime.utcfromtimestamp(time_end).strftime('%H:%M:%S')
            print("Restart at midnight time: then End:")
            print(time_start_use)
            print(time_end_use)
            # peak_energy_start = datetime.utcfromtimestamp(1573029000).strftime('%H:%M:%S')
            # peak_energy_end = datetime.utcfromtimestamp(1573075800).strftime('%H:%M:%S')
            # self.log("Peak Energy Start: %s"%str(peak_energy_start))
            ...
            #     self.log("Peak Energy Cost Time, Turn off Heaters unless dangerously low")
            #     pool3_low = pool3_low_night
            #     pool4_low = pool4_low_nights

            # If time is between sunrise and sunset then use the day temperature values
            if(time > time_start_use and time < time_end_use):
                print("Restart the Pi")
                self.restart_pi(True)
                
            # If time 
            elif(time < time_start_use or time > time_end_use):
                print("Outside Restart Time")
        except Exception as e:
            print(e)
            print("Failed the restart at midnight")
    ...
    # Look at current sonoffs on list.
    def look_sonoffs(self):
        self.gsheets_retrieve_data("Control!E2:E20",)
    ...
    def notification_start(self):
        ...
        if(send_notification_text == True and self.notification_text_sent_out == False):
            text = "Greenspring Farm Notification Update: Current Time: " + str(time)
            self.send_text(text, 'Conrad')
            self.send_text(text, 'Mickey')
            self.notification_text_sent_out = True




        # pool1_high, pool1_low_day, pool1_low_night , pool2_high,pool2_low_day, pool2_low_night, pool3_high, pool3_low_day, pool3_low_night, pool4_high, pool4_low_day, pool4_low_night, sunrise, sunset, pool2_5_high, pool2_5_low_day, pool2_5_low_night
        # control_values2[1], control_values2[2], control_values2[3], control_values2[4], control_values2[5], control_values2[6], control_values2[7], control_values2[8], control_values2[9], control_values2[10], control_values2[11], control_values2[12], sunrise, sunset, control_values3[0], control_values3[1], control_values3[2]
    def change_pool_rules(self,pool1_high, pool1_low_day, pool1_low_night , pool2_high,pool2_low_day, pool2_low_night, pool3_high, pool3_low_day, pool3_low_night, pool4_high, pool4_low_day, pool4_low_night, sunrise, sunset, pool2_5_high, pool2_5_low_day, pool2_5_low_night, pool3_5_high, pool3_5_low_day, pool3_5_low_night, time_before_sunrise, time_before_sunset):
        time = self.get_time()
        ...
        if(sunset == 0 and sunrise == 0):
            ...
            sunrise_delay = time_before_sunrise * 3600
            sunset_delay = time_before_sunset * 3600
            sunset_use = sunset - sunset_delay
            sunset_use = datetime.utcfromtimestamp(sunset_use).strftime('%H:%M:%S')
            sunrise_use = sunrise - sunrise_delay
            sunrise_use = datetime.utcfromtimestamp(sunrise_use).strftime('%H:%M:%S')
            # self.log("Sunrise time: %s"%str(sunrise_use))
            # self.log("Sunset time: %s"%str(sunset_use))
        ...
        pool3_turn_off = pool3_turn_off - 3
        pool3_turn_off = str(pool3_turn_off)
        print(pool3_turn_off)

        pool1_turn_off = int(pool1_high)
        pool1_turn_off = pool1_turn_off - 3
        pool1_turn_off = str(pool1_turn_off)
        print(pool1_turn_off)

        pool2_turn_off = int(pool2_high)
        pool2_turn_off = pool2_turn_off - 3
        pool2_turn_off = str(pool2_turn_off)
        print(pool2_turn_off)

        pool2_5_turn_off = int(pool2_5_high)
        print(pool2_5_turn_off)
        pool2_5_turn_off = pool2_5_turn_off - 3
        pool2_5_turn_off = str(pool2_5_turn_off)
        print(pool2_5_turn_off)

        pool3_5_turn_off = int(pool3_5_low)
        print(pool3_5_turn_off)
        pool3_5_turn_off = pool3_5_turn_off + 3
        pool3_5_turn_off = str(pool3_5_turn_off)
        print(pool3_5_turn_off)

        try:
            # Coolers
            pool4_cooler_change_rule = "http://192.168.1.18/cm?cmnd=RULE ON DS18B20%23Temperature>" + pool4_high + "DO Power on ENDON ON DS18B20%23Temperature<" + pool4_turn_off + "DO Power off ENDON"
            pool3_cooler_change_rule = "http://192.168.1.7/cm?cmnd=RULE ON DS18B20%23Temperature>" + pool3_high + " DO Power on ENDON ON DS18B20%23Temperature<" + pool3_turn_off + " DO Power off ENDON"
            pool1_cooler_change_rule = "http://192.168.1.29/cm?cmnd=RULE ON DS18B20%23Temperature>" + pool1_high + " DO Power on ENDON ON DS18B20%23Temperature<" + pool1_turn_off + " DO Power off ENDON"
            pool2_cooler_change_rule = "http://192.168.1.100/cm?cmnd=RULE ON DS18B20%23Temperature>" + pool2_high + " DO Power on ENDON ON DS18B20%23Temperature<" + pool2_turn_off + " DO Power off ENDON"
            pool2_5_cooler_change_rule = "http://192.168.1.47/cm?cmnd=RULE ON DS18B20%23Temperature>" + pool2_5_high + " DO Power on ENDON ON DS18B20%23Temperature<" + pool2_5_turn_off + " DO Power off ENDON"
            # Heaters
            pool3_5_heater_change_rule = "http://192.168.1.4/cm?cmnd=RULE BACKLOG ON DS18B20%23Temperature<" + pool3_5_low + " DO Power on ENDON ON DS18B20%23Temperature>" + pool3_5_turn_off + " DO Power off ENDON; Delay 100 ENDON"
            print(pool3_5_heater_change_rule)
            # ---------------Change Rules--------------
            # self.send_http(self.pool1_heater__change_rule)
            self.send_http(pool1_cooler_change_rule)
            self.send_http(pool2_cooler_change_rule)
            self.send_http(pool3_cooler_change_rule)
            self.send_http(pool4_cooler_change_rule)
            self.send_http(pool2_5_cooler_change_rule)
            self.send_http(pool3_5_heater_change_rule)
        except Exception as e:
            print(e)
            print("Failed Changing Rule")

    def carbonate_pools(self, pool_number, start_time, end_time):
        current_time = self.get_time()
        ...
        # Start time is greater than end time meaning 10 pm - 4 Am
        if(end_time < start_time):
            if(current_time > start_time or current_time < end_time):
                print("Past the Start Time or before the end time")
                if(pool_number == "3"):
                    if(self.carbonate_pools):
                        print("Activate Pool 3 Carbonation")
                        if(self.pool_3_carbonation_active == False):
                            self.send_http(self.pool_3_carbonation_on)
                            self.pool_3_carbonation_active = True
                            self.send_http(self.pool_4_carbonation_off)
                            self.pool_4_carbonation_active = False
                    ...
                    if(self.carbonate_pools):
                        print("Activate Pool 4 Carbonation")
                        if(self.pool_4_carbonation_active == False):
                            self.send_http(self.pool_4_carbonation_on)
                            self.pool_4_carbonation_active = True
                            self.send_http(self.pool_3_carbonation_off)
                            self.pool_3_carbonation_active = False
            if(current_time < start_time and current_time > end_time):
                self.send_http(self.pool_3_carbonation_off)
                self.send_http(self.pool_4_carbonation_off)
                self.gsheets_insert_single(self.spreadsheet_id, 'Control!','0', 'G5')


                print("It is not time for any carbonation")
        # End time is greater than start time meaning time like 4-8 pm
        try:
            if(end_time > start_time):
                if(current_time > start_time and current_time < end_time):
                    print("Past the Start Time or before the end time")
            ...
            print("Failed the carbonation check")
            print(e)

    def check_active_pools(self):
        try:   
            print("Check active pools!")
            active_pools = self.gsheets_retrieve_data('Control!D2:D7', self.spreadsheet_id)
            active_sensors = self.gsheets_retrieve_data('Control!I2:I13', self.spreadsheet_id)
            print(active_pools)
            ...
            # Check Sensors
            if(active_sensors[0] == '0'):
                self.pool_1_heating_active = False
                print("Pool 1 Heater Inactive")
            else:
                print("Pool 1 Heater Active")
            if(active_sensors[1] == '0'):
                self.pool_1_cooling_active = False
                print("Pool 1 Cooler Inactive")
            else:
                print("Pool 1 Cooler Active")

            if(active_sensors[2] == '0'):
                self.pool_2_heating_active = False
                print("Pool 2 Heater Inactive")
            else:
                print("Pool 2 Heater Active")
            if(active_sensors[3] == '0'):
                self.pool_2_cooling_active = False
                print("Pool 2 Cooler Inactive")
            else:
                print("Pool 2 Cooler Active")

            if(active_sensors[4] == '0'):
                self.pool_3_heating_active = False
                print("Pool 3 Heater Inactive")
            else:
                print("Pool 3 Heater Active")
            if(active_sensors[5] == '0'):
                self.pool_3_cooling_active = False
                print("Pool 3 Cooler Inactive")
            else:
                print("Pool 3 Cooler Active")

            if(active_sensors[6] == '0'):
                self.pool_4_heating_active = False
                print("Pool 4 Heater Inactive")
            else:
                print("Pool 4 Heater Active")
            if(active_sensors[7] == '0'):
                self.pool_4_cooling_active = False
                print("Pool 4 Cooler Inactive")
            else:
                print("Pool 4 Cooler Active")

            if(active_sensors[8] == '0'):
                self.pool_2_5_heating_active = False
                print("Pool 2_5 Heater Inactive")
            else:
                print("Pool 2_5 Heater Active")
            if(active_sensors[9] == '0'):
                self.pool_2_5_cooling_active = False
                print("Pool 2_5 Cooler Inactive")
            else:
                print("Pool 2_5 Cooler Active")

            if(active_sensors[10] == '0'):
                self.pool_3_5_heating_active = False
                print("Pool 3_5 Heater Inactive")
            else:
                print("Pool 3_5 Heater Active")
            if(active_sensors[11] == '0'):
                self.pool_3_5_cooling_active = False
                print("Pool 3_5 Cooler Inactive")
            else:
                print("Pool 3_5 Cooler Active")
        except:
            self.pool_1_active = True
            self.pool_2_active = True
            self.pool_3_active = True
...
class Sensor(hass.Hass):
    ...
    def initialize(self, address, name, role, sensor_type):
        self.pool_heater = "heater"
        self.pool_cooler = "cooler"
        self.general_sensor = "sensor"
        ...
        self.pool_cooler_on = False
        self.pool_heater_needs_on = False
        self.pool_cooler_needs_on = False


        if(role == self.pool_heater):
            print("Pool heater")
            self.pool_heater_turn_on = "http://192.168.1." + str(address) + "/cm?cmnd=Power%20On"
            self.pool_heater_turn_off = "http://192.168.1." + str(address) + "/cm?cmnd=Power%20off"
            self.pool_heater = "http://192.168.1." + str(address) + "/cm?cmnd=Power"
            # Status
            self.pool_heater_status = "http://192.168.1." + str(address) + "/cm?cmnd=Status%209"
            
            
        elif(role == self.pool_cooler):
            print("Pool Cooler")
            self.pool_cooler_turn_on = "http://192.168.1." + str(address) + "/cm?cmnd=Power%20On"
            self.pool_cooler_turn_off = "http://192.168.1." + str(address) + "/cm?cmnd=Power%20off"
            self.pool_cooler = "http://192.168.1." + str(address) + "/cm?cmnd=Power"
            # Status
            self.pool_cooler_status = "http://192.168.1." + str(address) + "/cm?cmnd=Status%209"

        elif(role == self.general_sensor):
            print("General Sensor")
    ...
    #---------------------Control Pool Temperature---------------------
        ...
        # @return: None
    #------------------------------------------------------------------
    def dynamic_control_pool_temp(self,pool1_high, pool1_low_day, pool1_low_night, sunrise, sunset):
        time = self.get_time()
        ...
        if(self.name == "Pool 1"):
            pool_active = self.pool_1_active
            pool_sensor = self.entities.sensor.pool1_temp.state
            



        #---------------------------------- Need to update!!! ----------------------------------
        self.dynamic_check_relays()
        self.dynamic_check_sensor()

       #-----------------Pool 4-------------------------
        if(self.pool__active):
            try:
                if(self.entities.sensor.pool_temp.state != "unknown"):
                    pool_conv = float(self.entities.sensor.pool4_temp.state)
                    if(pool4_conv > float(pool_high) and self.pool4_cooler_on != True and self.pool4_heater_on != True):
                        self.log("Pool 4 Cooler Turned On. Too Hot Temp: %s" % self.entities.sensor.pool4_temp.state)
                        self.pool_cooler_on = True 
                        try:
                            self.send_http(self.pool_cooler_turn_on)
                            textout = 'Pool  Cooler Turned on at ' + str(self.entities.sensor.pool4_temp.state)
                            # self.send_text(textout, "Conrad")
                        # Pool 4 Cooler is not responding
                        except:
                            self.log("Failed to http get request to the site.")
                            if(self.p_cooler_broken_on_checked == False):
                                self.check_sonoff_status()
                                self.p_cooler_broken_on_checked = True
                            elif(self.p_cooler_broken_on_text == False):
                                testtext = 'Pool  Turn Cooler On Failed, Please Check'
                                self.text_notification(testtext)
                                self.p_cooler_broken_on_text = True
                    if(pool_conv < float(pool_low) and self.pool_heater_on != True and self.pool_cooler_on != True):
                        self.log("Pool 4 Heater Turned On. Too Cool Temp: %s"% self.entities.sensor.pool_temp.state)
                        self.pool_heater_on = True
                        try:
                            self.send_http(self.pool_heater_turn_on)
                        # Pool 4 Heater is not responding
                        except:
                            if(self.p_heater_broken_on_checked == False):
                                self.check_sonoff_status()
                                self.p_heater_broken_on_checked = True
                            elif(self.p_heater_broken_on_text == False):
                                self.log("Failed to http get request to the site.")
                                testtext = 'Pool 4 Turn Heater On Failed, Please Check'
                                self.text_notification(testtext)
                                self.p_heater_broken_on_text==True
                    if(pool_conv < float(pool_high) and self.pool_cooler_on == True):
                        self.log("Pool 4 Cooler Turned Off. Current Temp: %s"% self.entities.sensor.pool4_temp.state)
                        self.pool_cooler_on = False
                        try:
                            self.send_http(self.pool4_cooler_turn_off)
                        except:
                            if(self.p_cooler_broken_off_checked == False):
                                self.check_sonoff_status()
                                self.p_cooler_broken_off_checked = True
                            elif(self.p_cooler_broken_off_text == False): 
                                self.log("Failed to http get request to the site.")
                                testtext = 'Pool 4 Turn Cooler Off Failed, Please Check'
                                self.text_notification(testtext)
                    if(pool4_conv > float(pool4_low) and self.pool4_heater_on == True):
                        ...
                        self.pool_heater_on = False
                        try:
                            self.send_http(self.pool_heater_turn_off)
                        except:
                            if(self.p_heater_broken_off_checked == False):
                                self.check_sonoff_status()
                                self.p_heater_broken_off_checked = True
                            elif(self.p_heater_broken_off_text == False): 
                                self.log("Failed to http get request to the site.")
                                testtext = 'Pool 4 Turn Heater Off Failed, Please Check'
                                self.text_notification(testtext)
            except:
    ...
    # if(self.pool_active):
    #     try:
    #         r = requests.get(url = self.pool_heater)
    #         data1 = r.json() 
    #         self.p_heater_broken_count = 0
    #         if(data1["POWER"] == "ON"):
    #             self.pool_heater_on = True
    #         else:
    #             self.pool_heater_on = False
    ...
    #         self.p_heater_broken == False
    #     except:
    #         self.p_heater_broken = True
    #         self.log("Pool 1 Heater is failing, probably off or not connected.")
    #         self.pool_heater_on = False
    #         self.p_heater
    #         if(self.p_heater_broken_count ==0):
    #             self.reassign_sonoff_address()
    #         if(self.p_heater_broken_count >2):
    #             text = "Pool 1 Heater Sonoff is not connected to network please check"
    #             self.text_notification(text)
    ...
    #     # Cooler
    #     try:
    #         r = requests.get(url = self.pool_cooler)
    #         data1 = r.json() 
    #         if(data1["POWER"] == "ON"):
    #             self.pool_cooler_on = True
    #         else:
    ...
    #     except Exception as e:
    #         print(e)
    #         self.p_cooler_broken = True
    #         self.log("Pool 1 cooler has failed and needs to be checked")
    #         self.pool_cooler_on = False
    #         if(self.p_cooler_broken_count==0):
    #             self.reassign_sonoff_address()
    #         self.p_cooler_broken_count = self.p_cooler_broken_count + 1

    #     if(self.p_cooler_broken == True and self.p_cooler_broken_count >2 and self.p_cooler_broken_off_text ==False):
    #         testtext='Pool 2 Temp and Cooling is not on the network.'

    #         self.text_notification(testtext)
    #         self.p_cooler_broken_off_text = True
